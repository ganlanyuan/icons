...
<body>
  ...
  <div class="collection">
    ...
    <br><h2>new</h2><div class="item"><svg role="img" title="add-circle-line" id="add-circle-line"><use xlink:href="#add-circle-line" /></svg><input type="text" class="icon-name" id="add-circle-line-copy" value="add-circle-line"><button class="copy-button" data-clipboard-action="copy" data-clipboard-target="#add-circle-line-copy">Copy</button></div>
    ...
    <div class="item"><svg role="img" title="dislike1-fill" id="dislike1-fill"><use xlink:href="#dislike1-fill" /></svg><input type="text" class="icon-name" id="dislike1-fill-copy" value="dislike1-fill"><button class="copy-button" data-clipboard-action="copy" data-clipboard-target="#dislike1-fill-copy">Copy</button></div>
